  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <span>
          <button type="button" class="btn btn-danger float-right " style="font-size:small; width:100px">Offer
            RM60</button>
        </span>
              ...
              <div class="col-sm">
                <div style="width: 100%;">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      Air R.O, Sarang Burung Walit, Kolagen Marin, Madu Kelulut, Ekstrak Akar Lalang, Pati Pisang, Gula
                      Batu, Vitamin C.
                    </p>
                    <div style="border-bottom: 1px #00000069 solid; margin-bottom: 10px;"></div>
