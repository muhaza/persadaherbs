              ...
              <div class="col-sm">
                <div style="width: 100%;">
                  ...
                  <div class="card-body">
                    ...
                    <div class="card">
                      <p style="font-size:small;padding-top:8px;margin-bottom: -3px;" class="text-center"> Diskaun lebih
                        rendah di Email anda! Subscribe sekarang! </p>
                      ...
                      <div id="mc_embed_signup">
                        <form
                          action="https://persadaherbs.us4.list-manage.com/subscribe/post?u=e280b122196abf8c33f52ba68&amp;id=82b9588ad5"
                          method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"
                          class="validate" target="_blank" novalidate>
                          <div id="mc_embed_signup_scroll">

                            <input style="width: 75%;border-radius: 10em;" type="email" value="" name="EMAIL"
                              class="email" id="mce-EMAIL" placeholder="email address" required>
                            <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                            <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text"
                                name="b_e280b122196abf8c33f52ba68_82b9588ad5" tabindex="-1" value=""></div>
                            <div class="clear"><input class="btn-primary"
                                style="border-radius: 10em;border:solid 1px transparent;padding:3px;" type="submit"
