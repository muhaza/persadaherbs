...
<!-- Modal -->
<div class="modal fade" id="agePersadaModal" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">

        <div class="modal-content">
            <div class="modal-header">
                <div class="col-sm">
                    <h5 class="modal-title" id="modalLongTitle">AGE DEFYING MASK</h5>
                </div>

                <span>
                    <button type="button" class="btn btn-danger float-right " style="font-size:small">RM110</button>
                </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <div style="width: 100%;">
                                    ...
                                    <img class="card-img-top" v-bind:src="ageImg" alt=" 📚Card image cap" />
                                    <div class="card-body">
                                       ...
                                       Cocamide Dea, Zingiber Officinale(ginger),Root Oil, Ocimum Basilicum (basil) Oil.
                                        ...
                                        <a href="https://wa.me/601158680328?text=Saya%20berminat%20untuk%20order%20Age-Defying" class="btn btn-success persada-button mt-1">Whatsapp</a>
