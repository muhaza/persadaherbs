...
<!-- Modal -->
<div class="modal fade" id="luzeaPersadaModal" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle"
    aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <div class="col-">
                    ...
                    <span style="margin-right: 10px;">
                        ...
                        <a href="#myLuzea"><button type="button" class="btn shopee"><i
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            Sumber : Ophthamol,I.J. (2012, Septamber). The accomplishments of global
                                            initiaive vision 2020.<br />
                                            <br />
                                            “Atas faktor kemajuan teknologi hari ini manusia tidak terlepas
                                            daripada<br />
                                            ...
                                            <div>
                                                <div>
                                                    Dalam kehidupan senarian, kita tidak dapat berpisah daripada
                                                    komputer,</div>
                                                <div>
                                                    televisyen dan alatan moden seperti telefon pintar, tablet dan
                                                    pelbagai lagi.</div>
                                                <div>
                                                    Mata kira cepat letih, tidak sampai ke tengah hari pandangan kita
                                                    menjadi kabur.</div>
                                                <div>
                                            ...
                                            <div>
                                                <ol>
                                                    <li>Penglihatan kabur merupakan gejala awal bagi kebanyakan masalah
                                                        mata.</li>
                                                    <li>Orang ramai beranggapan bahawa penglihatan kabur sebagai</li>
                                                    <li>keletihan (ketegangan mata) dan berterusan “membebankan” mata
                                                        mereka.</li>
                                                    <li>Mereka akan benar-benar menyesal apabila kehilangan</li>
                                                    <li>penglihatan mereka sepenuhnya.</li>
                                                    <li>Produk 3C bukan sahaja membawa kemudahan tetapi juga kesan
                                                        merbahaya kepada mata.</li>
                                                    <li>Anda haruslah berhenti melayari telefon bimbit atau menonton
                                                        filem dengan tablet semasa mata anda sakit, bebanan berlebihan
                                                    </li>
                                                    <li>pada mata kan memudaratkan penglihtan dan mengakibatkan kebutaan
                                                        sebelm tiba waktunya.</li>
                                                </ol>
                                                <div>
                                            ...
                                            <div>
                                                <ol>
                                                    <li>Brokoli juga mengandungi bela karoten, karoteroid yang
                                                        bermanfaat untuk penglihatan</li>
                                                    <li>Bayam memiliki jumlah antioksidan kuat untuk menurunkan risiko
                                                        pengembangan degenerasi makula</li>
                                                    <li>Kangkung membantu mata tetap sihat dalam mencegah katarak</li>
                                                    <li>Bunga Marigold mengandngi Vitamin A, yang menyihatkan
                                                        penglihatan</li>
                                                </ol>
                                                <div>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">Harga Pakej
                                                <button type="button"
                                                    class="btn btn-danger float-right">4/RM180</button>
                                            </li>

                                            <li class="list-group-item">Harga Ejen
                                                <button type="button"
                                                    class="btn btn-danger float-right">10/RM400</button>
                                            </li>

                                            <li class="list-group-item">Harga Pembekal
                                                <button type="button"
                                                    class="btn btn-danger float-right">100/RM3500</button>
                                            </li>

                                            <li class="list-group-item">Harga Pemborong
                                                <button type="button"
                                                    class="btn btn-danger float-right">1000/RM30,000</button>
                                            </li>
                                        </ul>
                                        ...
                                        <form class="form-inline">
                                            ...
                                            <button type="button" class="btn btn-primary mb-2"
                                                style="border-radius:25px;" onclick="myClipLuzea()">Copy No
                                                Akaun</button>
                                            <div id="doneLuzea"></div>
                                        </form>
                                        <!-- Bank Clipboard -->

                                        <a v-bind:href="luzeaShop" target="_blank"
                                            class="btn persada-button shopee mt-1">Beli di Shopee!</a>
                                        <a v-bind:href="luzeaWa" target="_blank"
                                            class="btn btn-success persada-button mt-1">Beli di Whatsapp</a>
                                        <a v-bind:href="luzeaFB" target="_blank"
                                            class="btn btn-primary persada-button mt-1">Beli di Facebook</a>
